...
*   _.identity({a: "b"}) === {a: "b"}
*/
//setup function with a parameter of value.
...
*   _.first(["a", "b", "c"], 2) -> ["a", "b"]
*/
 // create a function that take array a number as arguments.
...
_.some = function (collection, func) {
    ...
    if(_.filter(collection, func).length !== 0) {
        return true;
    } else {
        return false;
    }
...
_.extend = function(object1, ...etc) {
    _.each(etc, function(object, index, array){
